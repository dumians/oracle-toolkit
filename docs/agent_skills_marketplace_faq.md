...
The plugin is already embedded inside [`plugins/oracle-database-gcp/`](../plugins/oracle-database-gcp). Whenever you open the workspace in AGY or Gemini CLI, all skills and rules load automatically.
